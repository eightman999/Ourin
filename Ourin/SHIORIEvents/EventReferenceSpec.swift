...
public enum EventReferenceTable {
    ...
    public static let allSpecs: [EventReferenceSpec] = [
        ...
        .init(id: "OnFullScreenAppMinimize", references: [], category: "system"),
        .init(id: "OnFullScreenAppRestore", references: [], category: "system"),
        .init(id: "OnSysSuspend", references: [], category: "system"),
        .init(id: "OnSleep", references: [], category: "system"),
        .init(id: "OnSysResume", references: [], category: "system"),
