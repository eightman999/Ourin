...
public enum EventReferenceTable {
    ...
    public static let allSpecs: [EventReferenceSpec] = [
        ...
        .init(id: "OnSurfaceChange", references: ["surfaceID"], category: "shell"),
        .init(id: "OnSurfaceRestore", references: [], category: "shell"),
        .init(id: "OnSurfacesReloaded", references: ["shellName"], category: "shell"),
        .init(id: "OnDressupChanged", references: ["dressupName"], category: "shell"),
        ...
        .init(id: "OnExecuteHTTPStreaming", references: ["url", "method"], category: "network"),
        ...
        .init(id: "OnNarCreating", references: [], category: "update"),
        ...
        .init(id: "OnHeadlineCheck", references: [], category: "network"),
        .init(id: "OnBIFF", references: [], category: "network"),

        // MARK: - ウィンドウ / トレイ
        .init(id: "OnWindowStateMinimize", references: [], category: "ui"),
        .init(id: "OnWindowStateRestore", references: [], category: "ui"),
        .init(id: "OnTrayBalloonClick", references: ["identifier", "title", "message"], category: "ui"),
        .init(id: "OnSecurityWarning", references: ["source", "detail"], category: "system"),

        // MARK: - SSTP
        .init(id: "OnSSTPBlacklisting", references: [], category: "sstp"),
        .init(id: "OnSSTPBreak", references: [], category: "sstp"),
